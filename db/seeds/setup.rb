...
AccountType.find_or_create_by!(code: "BANK")    { |at| at.assign_attributes(role: "asset",   name: "Conta Corrente") }
AccountType.find_or_create_by!(code: "CREDIT")  { |at| at.assign_attributes(role: "asset",   name: "Cartão de Crédito") }
