...
Rails.application.configure do
  ...
  # Enable serving static files from `public/` for preprod environment
  ...
  config.force_ssl = false  # Disabled for local preprod
...
# config/environments/preprod.rb - Adicione estas linhas:
  ...
  # Performance like production
  config.cache_classes = true
  config.action_controller.perform_caching = true

  # Background jobs (se usar Sidekiq)
