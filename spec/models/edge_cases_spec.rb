...
RSpec.describe 'Transaction Edge Cases', type: :model do
  ...
  it 'deduplicates identical transactions during import' do
    # Fingerprint-based dedup is handled by ImportedTransaction; this validates model-level
    # A second transaction with the same fingerprint should not be persisted
    skip 'Dedup integration covered in ImportedTransaction specs'
  end
end
