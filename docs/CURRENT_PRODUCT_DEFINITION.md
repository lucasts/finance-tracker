...
- Projected balance after all commitments inside the horizon: the month's transactions plus recurring commitments (3-month horizon) and installment plans (6-month horizon). See `PROJECTION_SERVICES.md`
